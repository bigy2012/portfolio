...
export default function Contract() {
  ...
  return (
    <div>
      ...
      <div className="sm:px-5 sm:mt-5 lg:px-56 lg:py-40 bg-gray-50 z-0">
        <form method="POST">
          ...
          <div className="mt-5 w-[100%]">
            <h1>Name</h1>
            <input type="text" className="border sm:w-[100%] lg:w-[50%] p-2 text-black" name="full_name" />
          </div>
          <div className="mt-5 w-[100%]">
            <h1>Email</h1>
            <input type="email" className="border sm:w-[100%] lg:w-[50%]  p-2 text-black" name="email" />
          </div>
          <div className="mt-5">
            <h1>Message</h1>
            <textarea name="message" className="border sm:w-[100%] lg:w-[50%]  p-2 text-black" />
          </div>
